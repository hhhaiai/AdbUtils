...
//        testPush();
    ...
    private static void test() throws Exception {
        ...
        if ("Hello world".equals(responseText.trim())) {
            Logs.i("测试打印成功。 测试方法[shell:echo Hello world]");
        } else {
            Logs.e("测试打印失败。 测试方法[shell:echo Hello world], 结果:" + responseText);
        }
        ...
        if ("Hello world".equals(responseText.trim())) {
            Logs.i("测试流式操作成功。 测试方法[shell:--->echo Hello world]");
        } else {
            Logs.e("测试流式操作失败。 测试方法[shell:--->echo Hello world], 结果:" + responseText);
        }
