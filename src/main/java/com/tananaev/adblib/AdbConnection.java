...
public class AdbConnection implements Closeable {
     ...
     * @param throwOnUnauthorised Whether to throw an {@link RuntimeException}
     ...
     * @throws IOException          If the socket fails while connecting
     * @throws InterruptedException If we are unable to wait for the connection to finish
     * @throws RuntimeException     If {@code throwOnUnauthorised} is {@code true}
     ...
     */
    public boolean connect(long timeout, TimeUnit unit, boolean throwOnUnauthorised) throws IOException, InterruptedException, RuntimeException {
        if (connected)
