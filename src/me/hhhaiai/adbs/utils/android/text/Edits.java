 ...
 * {@link Iterator} can be used for queries.
 * <p>
 ...
 * {@link Iterator#next()} methods are called. They are identical to the non-change iterators when
 * their {@link Iterator#findSourceIndex(int)} method is used to walk through the string.
 * <p>
